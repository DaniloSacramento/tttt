              ...
              actions: <Widget>[
                ...
                if (confirmDelete)
                  TextButton(
                    ...
                    onPressed: () async {
                      bool deleted = await concluirCheckin(cpf: user!.cpf, checkInId: checkInId!);
                      if (deleted) {
                      ...
                      child: Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            String ultimosSeisNumeros = notasFiscais[index].chaveNf.substring(notasFiscais[index].chaveNf.length - 6);
                            bool showFornecedorName = index == 0 || notasFiscais[index].fornecedorDesc != notasFiscais[index - 1].fornecedorDesc;
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                Card(
                                  ...
                                  child: ListTile(
                                    title: Text('NF: ${notasFiscais[index].numNf}-${notasFiscais[index].serieNf}'),
                                    subtitle: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text('Status: ${notasFiscais[index].statusDesc}'),
                                      ],
                                    ),
                                    trailing: IconButton(
                                      icon: const Icon(
